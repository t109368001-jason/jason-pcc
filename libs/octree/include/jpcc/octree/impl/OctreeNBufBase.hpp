...
//////////////////////////////////////////////////////////////////////////////////////////////
template <uint8_t BUFFER_SIZE, typename LeafContainerT, typename BranchContainerT>
const typename OctreeNBufBase<BUFFER_SIZE, LeafContainerT, BranchContainerT>::Iterator
...
//////////////////////////////////////////////////////////////////////////////////////////////
template <uint8_t BUFFER_SIZE, typename LeafContainerT, typename BranchContainerT>
const typename OctreeNBufBase<BUFFER_SIZE, LeafContainerT, BranchContainerT>::LeafNodeDepthFirstIterator
...
//////////////////////////////////////////////////////////////////////////////////////////////
template <uint8_t BUFFER_SIZE, typename LeafContainerT, typename BranchContainerT>
const typename OctreeNBufBase<BUFFER_SIZE, LeafContainerT, BranchContainerT>::DepthFirstIterator
...
//////////////////////////////////////////////////////////////////////////////////////////////
template <uint8_t BUFFER_SIZE, typename LeafContainerT, typename BranchContainerT>
const typename OctreeNBufBase<BUFFER_SIZE, LeafContainerT, BranchContainerT>::BreadthFirstIterator
...
//////////////////////////////////////////////////////////////////////////////////////////////
template <uint8_t BUFFER_SIZE, typename LeafContainerT, typename BranchContainerT>
const typename OctreeNBufBase<BUFFER_SIZE, LeafContainerT, BranchContainerT>::LeafNodeBreadthIterator
...
void OctreeNBufBase<BUFFER_SIZE, LeafContainerT, BranchContainerT>::switchBuffers(const uint8_t bufferSelector) {
  ...
  //   root_node_->setChildPtr(bufferSelector, child_idx, nullptr);
  // }
}

//////////////////////////////////////////////////////////////////////////////////////////////
template <uint8_t BUFFER_SIZE, typename LeafContainerT, typename BranchContainerT>
void OctreeNBufBase<BUFFER_SIZE, LeafContainerT, BranchContainerT>::serializeTree(
...
//////////////////////////////////////////////////////////////////////////////////////////////
template <uint8_t BUFFER_SIZE, typename LeafContainerT, typename BranchContainerT>
void OctreeNBufBase<BUFFER_SIZE, LeafContainerT, BranchContainerT>::serializeLeafs(
    std::vector<LeafContainerT*>& leaf_container_vector_arg) {
  OctreeKey new_key;
...
//////////////////////////////////////////////////////////////////////////////////////////////
template <uint8_t BUFFER_SIZE, typename LeafContainerT, typename BranchContainerT>
void OctreeNBufBase<BUFFER_SIZE, LeafContainerT, BranchContainerT>::deserializeTree(
...
uint8_t OctreeNBufBase<BUFFER_SIZE, LeafContainerT, BranchContainerT>::getBranchBitPattern(
  ...
  for (uint8_t i = 0; i < 8; i++) {
    ...
    node_bits |= static_cast<uint8_t>((!!child) << i);
  }
...
//////////////////////////////////////////////////////////////////////////////////////////////
template <uint8_t BUFFER_SIZE, typename LeafContainerT, typename BranchContainerT>
uint8_t OctreeNBufBase<BUFFER_SIZE, LeafContainerT, BranchContainerT>::getBranchXORBitPattern(
    const BranchNode& branch_arg) const {
  uint8_t node_bits[2];
  ...
  for (uint8_t i = 0; i < 8; i++) {
    ...
    node_bits[0] |= static_cast<uint8_t>((!!childA) << i);
    node_bits[1] |= static_cast<uint8_t>((!!childB) << i);
  }
...
//////////////////////////////////////////////////////////////////////////////////////////////
template <uint8_t BUFFER_SIZE, typename LeafContainerT, typename BranchContainerT>
bool OctreeNBufBase<BUFFER_SIZE, LeafContainerT, BranchContainerT>::hasBranchChanges(
    const BranchNode& branch_arg) const {
...
//////////////////////////////////////////////////////////////////////////////////////////////
template <uint8_t BUFFER_SIZE, typename LeafContainerT, typename BranchContainerT>
void OctreeNBufBase<BUFFER_SIZE, LeafContainerT, BranchContainerT>::serializeNewLeafs(
    std::vector<LeafContainerT*>& leaf_container_vector_arg) {
  OctreeKey new_key;
...
//////////////////////////////////////////////////////////////////////////////////////////////
template <uint8_t BUFFER_SIZE, typename LeafContainerT, typename BranchContainerT>
void OctreeNBufBase<BUFFER_SIZE, LeafContainerT, BranchContainerT>::serializeTreeRecursive(
    BranchNode*                            branch_arg,
    OctreeKey&                             key_arg,
    std::vector<char>*                     binary_tree_out_arg,
...
//////////////////////////////////////////////////////////////////////////////////////////////
template <uint8_t BUFFER_SIZE, typename LeafContainerT, typename BranchContainerT>
void OctreeNBufBase<BUFFER_SIZE, LeafContainerT, BranchContainerT>::deserializeTreeRecursive(
    BranchNode*                                            branch_arg,
    uindex_t                                               depth_mask_arg,
    OctreeKey&                                             key_arg,
