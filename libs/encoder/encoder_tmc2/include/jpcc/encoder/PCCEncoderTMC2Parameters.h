...
enum PCCCodecId { JMAPP = 0, HMAPP = 1, SHMAPP = 2, JMLIB = 3, HMLIB = 4, VTMLIB = 5, FFMPEG = 6, UNKNOWN_CODEC = 255 };

class PCCEncoderTMC2Parameters {
 public:
  PCCEncoderTMC2Parameters();
