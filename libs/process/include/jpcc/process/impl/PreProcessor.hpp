...
//////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT>
void PreProcessor<PointT>::process(GroupOfFrame<PointT>&     groupOfFrame,
  ...
  for (const std::string& algorithm : param_.order) {
    ...
    if (removedMap) {
      ...
      for (auto& frame : removed) { frame = jpcc::make_shared<Frame<PointT>>(); }
    }
...
void PreProcessor<PointT>::applyAlgorithm(const std::string&      algorithm,
                                          ...
                                          const FramePtr<PointT>& removed) const {
